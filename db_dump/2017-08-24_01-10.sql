...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 24 2017 г., 01:09
...
(17, 0, 0, 'products', 'Продукція@|;Продукция@|;Products@|;produkty@|;', '', '@|;@|;@|;@|;', '@|;@|;@|;@|;', '[]', '{"base":["title","short_description","priority","active"],"attributes":{"Картинка товара":{"type":"files","lang_active":false,"active":false}}}', '0000-00-00 00:00:00', 0, '@|;@|;@|;@|;', '@|;@|;@|;@|;', '@|;@|;@|;@|;', 0, '2017-08-23 17:20:32', '2017-08-23 17:20:51');
